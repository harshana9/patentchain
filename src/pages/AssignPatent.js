...
export default function AssignPatent(props) {
  let { id } = useParams()
                                                  ...
                                                  <div class="mb-3">
                                                    ...
                                                    <div class="row row-cols-4">
                                                      <div class="col-sm-11 col-lg-11" style={{ padding: '0px', paddingRight: '3px', paddingLeft: '25px', paddingBottom:'30px' }}>
                                                            ...
                                                            <table style={{width:'100%', fontSize: '10px'}} border="1">
                                                              <thead>
                                                                <tr><th>Assigner</th><th>Assignee</th><th>Transfer Date</th></tr>
                                                              </thead>
                                                              <tbody>
                                                              {props.ownerships.map((ownership, key) => {
                                                                  if (ownership.patentContainer.id == id) {
                                                ...
                                                <div class="card shadow mb-3">
                                                    ...
                                                    <div class="card-body">
                                                            ...
                                                            <div class="mb-3 float-right">
                                                              <button class="btn btn-success btn-sm" style={{ padding: '4px 20px', borderRadius: '2px', borderStyle: 'outset', marginLeft:'0px' }}  onClick= {() => {props.purchasePatent(patent.id,patent.price_license)}}>Buy Patent Owneship
                                                              </button>
                                                            </div>
                                                    </div>
                                                </div>
